...
import com.caojing.ricohsample.v2.model.ImageSize;
import com.caojing.ricohsample.v2.network.*;
import com.caojing.ricohsample.v2.view.*;
...
public class ImageListActivity extends AppCompatActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		SwitchCompat connectionSwitch = (SwitchCompat) menu.findItem(R.id.connection).getActionView();
